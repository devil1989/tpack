...
exports.task('build', function (options) {
    ...
    // 生成整个项目。
    this.builder.buildAll(options.clean);
...
exports.task('server', function (options) {
	initOptions(options);
    return exports.builder.startServer(options[1] || options.port || 8080);
});

// 启动服务器任务。
exports.task('open', function (options) {
	initOptions(options);
    var server = exports.builder.startServer(options[1] || options.port || 8080);
    if (server) {
