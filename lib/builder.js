...
Builder.prototype = {
    ...
    /**
     * 获取或设置将上传到 CDN 的地址名称。此文件夹将上传至 CDN。
     */
    cdnPath: null,
     ...
     * 获取或设置当前构建器的日志等级。
     */
    logLevel: Builder.LOG_LEVEL.info,
    ...
    build: function (clean) {
        ...
        if (clean == null ? this.srcPath.toLowerCase().indexOf(this.destPath.toLowerCase()) < 0 : clean) {
    ...
    watch: function () {
        ...
        var ignored = arguments.length && createRouter(arguments);
